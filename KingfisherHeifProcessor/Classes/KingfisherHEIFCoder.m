//
//  KingfisherHEIFCoder.m
//  KingfisherHEIFCoder
//
//  Created by kai on 2019/6/3.
//

#import "KingfisherHEIFCoder.h"
...
@implementation KingfisherHEIFCoder
...
- (UIImage *)decodedImageWithData:(NSData *)data {
    ...
    CGImageRef imageRef = [self createHEIFImageWithData:data];
    if (!imageRef) {
        return nil;
    }
...
- (nullable CGImageRef)createHEIFImageWithData:(nonnull NSData *)data CF_RETURNS_RETAINED {
...
- (NSData *)encodedDataWithImage:(UIImage *)image {
    ...
    data = [self encodedHEIFDataWithImage:image quality:compressionQuality];
...
- (nullable NSData *) encodedHEIFDataWithImage:(nonnull UIImage *)image quality:(double)quality {
    ...
    vImage_CGImageFormat destFormat = {
        ...
        .colorSpace = [self colorSpaceGetDeviceRGB],
